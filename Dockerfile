...
RUN mkdir -p ./static
COPY index.html login.html privacy.html config.js data.js recover.js app.js reel.js agent-timeline.js login.js styles.css favicon.png mark.png logo.png manifest.json sw.js ./static/
